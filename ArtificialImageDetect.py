...
main = tkinter.Tk()
main.title("Identifying Synthetic Images Using Local Binary Patterns") #designing main screen
...
title = Label(main, text='Identifying Synthetic Images Using Local Binary Patterns', justify=LEFT)
